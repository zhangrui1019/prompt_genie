      ...
      <div className="mx-auto max-w-[1600px]">
        ...
        {modelNames.length >= 2 && (
            <div className="bg-white rounded-lg shadow p-6 mb-8">
                <h2 className="text-xl font-bold text-gray-800 mb-4">A/B Effect Comparison</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h3 className="font-bold text-gray-700 mb-2">Win Rate</h3>
                        <div className="space-y-2">
                            {modelNames.map((modelA: string, indexA: number) => {
                                return modelNames.slice(indexA + 1).map((modelB: string) => {
                                    ...
                                    return (
                                        <div key={`${modelA}-${modelB}`} className="border rounded p-3">
                                            <div className="flex justify-between items-center mb-2">
                                                <span className="font-medium">{modelA} vs {modelB}</span>
                                            </div>
                                            <div className="grid grid-cols-3 gap-2 text-center">
                                                <div>
                                                    <div className="text-sm font-bold text-blue-600">{aWinRate}</div>
                                                    <div className="text-xs text-gray-500">{modelA} Wins</div>
                                                </div>
                                                <div>
                                                    <div className="text-sm font-bold text-green-600">{tieRate}</div>
                                                    <div className="text-xs text-gray-500">Ties</div>
                                                </div>
                                                <div>
                                                    <div className="text-sm font-bold text-red-600">{bWinRate}</div>
                                                    <div className="text-xs text-gray-500">{modelB} Wins</div>
                                                </div>
                                            </div>
                                        </div>
                                    );
                    ...
                    <div>
                        <h3 className="font-bold text-gray-700 mb-2">Performance Metrics</h3>
                        <div className="space-y-2">
                                ...
                                return (
                                    <div key={model} className="border rounded p-3">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <span className="text-sm text-gray-600">Avg Latency: {avgLatency}</span>
                                        </div>
