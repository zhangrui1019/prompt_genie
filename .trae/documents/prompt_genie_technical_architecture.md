...
| 参数名                | 参数类型   | 是否必需 | 描述                                   |
| ------------------ | ------ | ---- | ------------------------------------ |
| prompt\_id         | string | 是    | 提示词ID                                |
| model              | string | 否    | AI模型，默认gpt-4                         |
| optimization\_type | string | 否    | 优化类型：clarity, specificity, structure |
...
| 参数名             | 参数类型   | 是否必需 | 描述       |
| --------------- | ------ | ---- | -------- |
| prompt\_content | string | 是    | 提示词内容    |
| test\_variables | object | 否    | 测试变量     |
| model           | string | 否    | 测试模型     |
| test\_count     | number | 否    | 测试次数，默认1 |
