  ...
  const handleSelectPrompt = (promptId: string) => {
    ...
    if (selected) {
        ...
        if (selected.variables && Object.keys(selected.variables).length > 0) {
            const newVars = Object.keys(selected.variables).map(key => ({
                key,
                value: '' 
            }));
        ...
        return (
            <div className="mt-4 p-4 bg-gray-50 rounded border border-gray-200 flex gap-6 text-sm flex-wrap">
                <div className="flex flex-col gap-1">
                    <label className="text-gray-500 font-bold text-xs uppercase">Resolution</label>
                    <select 
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-gray-500 font-bold text-xs uppercase">Duration</label>
                    <select 
                    ...
                    >
                        ...
                        <option value={10}>10 Seconds (Wan 2.6 only)</option>
                    </select>
                </div>
                 <div className="flex flex-col gap-1">
                    <label className="text-gray-500 font-bold text-xs uppercase">Prompt Extend</label>
                    <select 
        ...
        return (
            <div className="mt-4 p-4 bg-gray-50 rounded border border-gray-200 flex gap-6 text-sm flex-wrap">
                <div className="flex flex-col gap-1">
                 ...
                 <div className="flex flex-col gap-1">
                    <label className="text-gray-500 font-bold text-xs uppercase">Count (n)</label>
                    <select 
                      value={imageParams.n} 
        ...
        <div className="grid gap-6 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm border border-gray-100 flex flex-col h-[500px]">
              ...
              <textarea
                className="flex-1 w-full rounded border p-3 focus:border-blue-500 focus:outline-none font-mono text-sm resize-none bg-gray-50 focus:bg-white transition"
          ...
          <div className="lg:col-span-8 flex flex-col h-full space-y-6">
             ...
             <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                 <div className="flex items-center justify-between">
                     <div className="flex gap-4 items-center">
                         <span className="text-sm font-bold text-gray-500 uppercase">Models:</span>
                     ...
                     <div className="flex flex-col items-end mr-4">
                         <span className="text-xs text-gray-400 uppercase font-bold">Est. Cost</span>
                     ...
                     >
                        {isRunning ? t('playground.running') : 'RUN'}
                     </button>
                 </div>
                     ...
                     return (
                         <div key={modelId} className="bg-white rounded-lg shadow-sm border border-gray-100 flex flex-col overflow-hidden h-[600px]">
                             <div className="bg-gray-50 px-4 py-2 border-b border-gray-100 flex justify-between items-center">
                                 ...
                                 {result?.output && (
                                     <button 
                                        onClick={() => {navigator.clipboard.writeText(result.output); toast.success('Copied!');}}
      ...
      {showHistory && (
          <div className="fixed inset-y-0 right-0 w-96 bg-white shadow-2xl z-50 flex flex-col border-l border-gray-200 animate-slide-in-right">
              <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
                  <h2 className="font-bold text-gray-800">Execution History</h2>
                  <button onClick={() => setShowHistory(false)} className="text-gray-400 hover:text-gray-600 text-xl">&times;</button>
              </div>
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  {history.length === 0 ? (
                      <div className="text-center text-gray-400 py-8 italic text-sm">No history yet</div>
                  ) : (
                      history.map(item => (
                          <div 
                              key={item.id} 
              ...
              <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md animate-scale-in">
                  ...
                  <div className="space-y-4">
                      <div className="bg-blue-50 p-4 rounded-lg flex justify-between items-center">
                          <span className="text-blue-700 font-bold">Total Cost</span>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="bg-gray-50 p-3 rounded border border-gray-100">
                              <div className="text-xs text-gray-500 uppercase">Images Generated</div>
                              <div className="text-lg font-mono font-semibold">{stats.total_images}</div>
                          </div>
                          <div className="bg-gray-50 p-3 rounded border border-gray-100">
                              <div className="text-xs text-gray-500 uppercase">Videos Generated</div>
